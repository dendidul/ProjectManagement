    ...
    document.addEventListener("DOMContentLoaded", function () {
        {
            ...
            function u() {
                (w.value = ""), (x.value = ""), (k.value = ""), (E.value = ""), (P.value = ""), (T.checked = !1), D.val("").trigger("change"), (M.value = "");
            }
            FormValidation.formValidation(c, {
                    ...
                    y.classList.contains("btn-add-event")
                        ? r &&
                          ((n = {
                              ...
                              endStr: w.value,
                              display: "block",
                              extendedProps: { location: P.value, guests: D.val(), calendar: q.val(), description: M.value },
                          }),
                ...
                h.addEventListener("click", (e) => {
                    b && (b.innerHTML = "Add Event"), (y.innerHTML = "Add"), y.classList.remove("btn-update-event"), y.classList.add("btn-add-event"), S.classList.add("d-none"), m.classList.remove("show"), f.classList.remove("show");
                }),
                A &&
