...
namespace Infrastructure.WebServices
{
    public class LoyaltyAPIService : ILoyaltyAPIService
    {
            ...
            IRedisCache cache)
        {
            ...
            _cache = cache;
            _apiPath = _config.Get("External:API:Loyalty:URL.String");
            _clientApiSecret = _config.Get("External:API:Loyalty:ClientApiSecret.String");
            _clientApiKey = _config.Get("External:API:Loyalty:ClientApiKey.String");
            _headerType = RequestHeaderType.APPLICATION_X_WWW_FORM_URLENCODED;
            _loyaltyRedisToken = "LoyaltyAPI:AccessTokenLoyaltyPOSKHD";
        }
        ...
        public string GetToken()
        {
            try
            {
                ...
                string accessToken = _cache.Get(_loyaltyRedisToken);
                ...
                using (var client = new HttpClient())
                {
                    ...
                    var result = JsonConvert.DeserializeObject<LoyaltyResponseData<LoyaltyAccessTokenResponse>>(response.Content.ReadAsStringAsync().Result);
                    ...
                    _cache.Set(_loyaltyRedisToken, accessToken, lifeTime);
                }
        ...
        public HttpResponseMessage PostJsonAsyncWithToken<T>(string relativeUri, T obj, bool useSignature = false)
        {
            ...
            try
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    client.DefaultRequestHeaders.Add("ApplicationChannel", "103315");
